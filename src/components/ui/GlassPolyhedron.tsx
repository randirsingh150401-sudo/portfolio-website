            ...
            {FACES.map((face, i) => (
              <div
                ...
                style={{
                  ...
                  background:
                    i % 2 === 0
                      ? "linear-gradient(135deg, rgba(167,139,250,0.28), rgba(56,189,248,0.08))"
                      : "linear-gradient(135deg, rgba(56,189,248,0.22), rgba(167,139,250,0.06))",
                  boxShadow: "inset 0 0 40px rgba(255,255,255,0.06), 0 0 60px rgba(167,139,250,0.15)",
                }}
              />
            ))}
          </div>
