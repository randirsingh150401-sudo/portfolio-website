    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-gradient-to-r from-primary to-accent text-background hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] shadow-[0_8px_20px_rgba(0,0,0,0.35),0_0_30px_-10px_rgba(var(--color-primary-rgb)/0.42)] hover:shadow-[0_10px_25px_rgba(0,0,0,0.4),0_0_45px_-8px_rgba(var(--color-primary-rgb)/0.62)]": variant === "primary",
