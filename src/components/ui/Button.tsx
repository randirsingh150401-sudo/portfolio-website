    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-gradient-to-r from-primary to-accent text-white hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] shadow-[0_8px_20px_rgba(0,0,0,0.35),0_0_30px_-10px_rgba(232,121,249,0.35)] hover:shadow-[0_10px_25px_rgba(0,0,0,0.4),0_0_45px_-8px_rgba(232,121,249,0.55)]": variant === "primary",
