    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="container px-6 mx-auto relative z-10">
        <motion.div 
          ...
          className="max-w-3xl mx-auto bg-surface/50 backdrop-blur-xl border border-white/10 rounded-[3rem] p-12 md:p-20 text-center"
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            {contact.title}
          </h2>
          <p className="text-xl text-text-secondary mb-12 max-w-xl mx-auto leading-relaxed">
            {contact.description}
          </p>
          
          <a href={`mailto:${contact.email}`}>
            <Button size="lg" className="w-full sm:w-auto text-lg px-12 py-8 rounded-2xl gap-3">
              <Mail size={24} />
              Say Hello
            </Button>
          </a>
          ...
          <div className="mt-16 pt-10 border-t border-white/10 flex items-center justify-center gap-6">
            <a href={contact.socials.github} target="_blank" rel="noreferrer" className="text-text-secondary hover:text-primary transition-colors p-3 hover:bg-primary/10 rounded-full">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
            </a>
            <a href={contact.socials.twitter} target="_blank" rel="noreferrer" className="text-text-secondary hover:text-accent transition-colors p-3 hover:bg-accent/10 rounded-full">
            ...
            <a href={contact.socials.linkedin} target="_blank" rel="noreferrer" className="text-text-secondary hover:text-primary transition-colors p-3 hover:bg-primary/10 rounded-full">
