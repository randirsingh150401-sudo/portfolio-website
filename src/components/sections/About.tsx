      ...
      <div className="container px-6 mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-lg text-text-secondary leading-relaxed max-w-3xl">
            <p>
              We are developers and AI automation builders with <strong className="text-text-primary font-semibold">4+ years of experience in coding, software development, and building intelligent agent-based systems</strong>.
            </p>
            <p>
              Our work focuses on turning complex business processes into <strong className="text-text-primary font-semibold">AI-powered automated workflows</strong>. We build AI agents that can research information, analyze data, make decisions, generate content, interact with APIs, and execute tasks across different platforms.
            </p>
            <p>
              Over the years, we’ve worked with technologies including <strong className="text-text-primary font-semibold">Python, JavaScript, APIs, databases, cloud platforms, AI/LLMs, automation systems, and third-party integrations</strong>. We enjoy working on projects where AI is not just used for generating text, but is connected to real tools and can actually <strong className="text-text-primary font-semibold">perform actions and complete workflows</strong>.
            </p>

            <h3 className="text-2xl font-bold text-text-primary mt-12 mb-6">What We Build</h3>
            ...
            <h3 className="text-2xl font-bold text-text-primary mt-12 mb-6">Our Approach</h3>
            <p>
              We believe the future of software is moving from applications that simply <strong className="text-text-primary font-semibold">wait for users to click buttons</strong> toward intelligent systems that can understand a goal and execute the work themselves.
            </p>
            <p>
              That’s why we focus on building agents with clear workflows, tool access, approval systems, memory, error handling, and human oversight where necessary.
            </p>
            <p>
              We are constantly experimenting with new AI models, agent architectures, automation techniques, and developer tools to build software that is <strong className="text-text-primary font-semibold">smarter, more autonomous, and genuinely useful</strong>.
            </p>
