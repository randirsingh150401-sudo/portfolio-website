        ...
        <div className="px-4 pb-6" style={{ transform: "translateZ(20px)" }}>
          ...
          {project.link && (
            <a
              ...
              className="inline-flex items-center justify-center min-h-[44px] px-5 py-2.5 text-sm font-medium rounded-lg bg-primary/10 text-primary hover:bg-primary/20 transition-colors"
            >
